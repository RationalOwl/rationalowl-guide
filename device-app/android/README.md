...
- [래셔널아울 Android 단말 앱 개발 가이드](#래셔널아울-android-단말-앱-개발-가이드)
    - [목차](#목차)
...
- Build.gradle 파일의 dependencies에 아래와 같이 compile ‘패키지명:파일명:버전@aar’ 을 입력한다.
...
- manifest파일에서 BroadcastReceiver에서 6개의 액션을 추가한다.
