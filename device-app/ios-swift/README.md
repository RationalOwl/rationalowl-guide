...
- <a href="https://guide.rationalowl.com/library" target="_blank">IOS 단말앱 라이브러리를 다운</a> 받는다.
...
1. [MinervaManager.h](https://github.com/RationalOwl/rationalowl-sample/blob/master/device-app/ios-swift/RationalOwl.framework/Headers/MinervaManager.h)
 - 단말앱 등록/등록헤제 API
 - 업스트림 메시지 발신 API
 - P2P 메시지 발신 API
 - 단말앱 라이프사이클 관련 API
...
2. [MinervaDelegate.h](https://github.com/RationalOwl/rationalowl-sample/blob/master/device-app/ios-swift/RationalOwl.framework/Headers/MinervaDelegate.h)
...
3. [Result.h](https://github.com/RationalOwl/rationalowl-sample/blob/master/device-app/ios-swift/RationalOwl.framework/Headers/Result.h)
